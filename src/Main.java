...
public class Main {
    ...
    static final int IMAGE_HEIGHT = 1920;
    ...
    private static void setupCornellBox(Scene renderScene) {
        ...
        Material white = new ReflectiveMaterial(RgbColor.WHITE, new RgbColor(0.85f, 0.85f, 0.85f), AMBIENT_LIGHT, 32f, 0.8f, false);
        Material yellow = new ReflectiveMaterial(RgbColor.YELLOW, RgbColor.WHITE, AMBIENT_LIGHT, 32f, 0.8f, false);
        Material green = new ReflectiveMaterial(RgbColor.RED, RgbColor.WHITE, AMBIENT_LIGHT, 32f, 0.8f, false);
        ...
        renderScene.addObject(new Sphere(new Vec3(1.5f, 0, -1), 1f, white));

        Material metallic = new ReflectiveMaterial(RgbColor.MAGENTA, RgbColor.WHITE, AMBIENT_LIGHT, 64f, 0.1f, true);
        renderScene.addObject(new Sphere(new Vec3(-2, -3, 0), 1f, metallic));

        Material refractive = new RefractiveMaterial(1.5f);
        //renderScene.addObject(new Sphere(new Vec3(0f, -3, 2), 1f, refractive));
